                    ...
                    data-wow-delay=".7s">
                        <div class="tp-about__right-side tp-about__right-box">
                            <div class="tp-about__section-title pb-25">
                                <span class="tp-section-subtitle-2">OUR POOREX CHARITY CENTER</span>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="tp-cta-2__content text-center">
                                ...
                                <a href="donation-sidebar.php" class="tp-btn big">Start Donating Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tp-team-2__item text-center">
                                ...
                                <div class="tp-team-2__content">
                                    <div class="tp-team-2__author-info">
                                        <a href="team-details.php"><h4 class="tp-team-2__author-name">Kaira Beasley</h4></a>
                                        <span>Volunteer</span>
                                    </div>
                    ...
                    data-wow-delay=".5s">
                        <div class="tp-team-2__wrapper">
                            <div class="tp-team-2__item text-center">
                                ...
                                <div class="tp-team-2__content">
                                    <div class="tp-team-2__author-info">
                                        <a href="team-details.php"><h4 class="tp-team-2__author-name">Charlotte Ava</h4></a>
                                        <span>Volunteer</span>
                                    </div>
                                    <div class="tp-team-2__social-box">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                    ...
                    data-wow-delay=".7s">
                        <div class="tp-team-2__wrapper">
                            <div class="tp-team-2__item text-center">
                                ...
                                <div class="tp-team-2__content">
                                    <div class="tp-team-2__author-info">
                                        <a href="team-details.php"><h4 class="tp-team-2__author-name">Alessio Done</h4></a>
                                        <span>Volunteer</span>
                                    </div>
                                    <div class="tp-team-2__social-box">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
