                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tp-breadcrumb__content z-index-5">
                            ...
                            <h3 class="tp-breadcrumb__title">Donations</h3>
                         </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-40 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                        <div class="tp-donate-2__item">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="tp-donate-2__thumb">
                                        <img src="assets/img/donate/donate-2-5.png" alt="">
                                        <div class="tp-donate-2__thumb-text">
                                        <a href="donation-details.php"><i class="flaticon-tag"></i>CHARITY</a>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="basic-pagination text-center pt-30">
                            <nav>
                               <ul>
                                  <li>
                                     <a href="donation-details.php">1</a>
                                  </li>
                                  <li>
                                     <a href="donation-details.php">2</a>
                                  </li>
                                  <li>
                                     <a href="donation-details.php">3</a>
                                  </li>
                                  <li>
                                     <a href="donation-details.php">
