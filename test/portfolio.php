                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tp-breadcrumb__content z-index-5">
                            ...
                            <h3 class="tp-breadcrumb__title">Gallery</h3>
                         </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    data-wow-delay=".3s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-4.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-4.jpg">
                    ...
                    data-wow-delay=".7s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-6.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-6.jpg">
                    ...
                    data-wow-delay="1s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-8.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-8.jpg">
                    ...
                    data-wow-delay="1.2s">
                        <div class="tp-gallery-3__item p-relative">
                            <img src="assets/img/gallery/gal-3-9.jpg" alt="">
                            <div class="tp-gallery-3__icon">
                                <a class="popup-image" href="assets/img/gallery/gal-3-9.jpg">
                    ...
                    <div class="col-xl-12">
                        <div class="basic-pagination text-center pt-30">
                            <nav>
                               <ul>
                                  <li>
                                     <a href="portfolio.php">1</a>
                                  </li>
                                  <li>
                                     <a href="portfolio.php">2</a>
                                  </li>
                                  <li>
                                     <a href="portfolio.php">3</a>
                                  </li>
                                  <li>
