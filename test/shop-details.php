...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tp-breadcrumb__content z-index-5">
                            ...
                            <h3 class="tp-breadcrumb__title">Shop Details</h3>
                         </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tp-product-details-area pt-120 pb-120">
            <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="tp-shop-details__right-warp">
                        <h3 class="tp-shop-details__title-sm">Minimal Wood Chair</h3>
                        <div class="tp-shop-details__price">
                        <span>$340.00</span>
                        <span class="text-theme">$280.00</span>
                    </div>
                        ...
                        <p>Charity is the act of extending love and kindness to others uncondit <br> 
                            onalwhich is a conscious act but the decision is made by the <br>
                            heart, without expecting a reward. When Charity
                        </p>
                        </div>
                        <div class="tp-shop-details__product-info">
                        <ul>
                            <li><i class="fa-solid fa-check"></i>Sed ut perspiciatis unde natus</li>
                            <li><i class="fa-solid fa-check"></i>Maecenas tempor velit sit amet euismo</li>
                        </ul>
                        </div>
                        <div class="tp-shop-details__quantity-wrap">
                        <div class="tp-shop-details__quantity-box d-flex align-items-center">
                            <span>Quantity</span>
                        ...
                        <div class="tp-shop-details__btn w-100">
                            <a class="tp-btn mr-20" href="cart.php">Add To Cart</a>
                            <a class="theme-btn" href="cart.php">Add to Wishlist</a>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                <div class="tp-shop-details__text-box">
                    <h4 class="tp-shop-details__title">Our Description</h4>
                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et <br> quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et <br> dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio.</p>
                    <p class="pb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et <br> quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et  <br>dolorum fuga similique sunt in culpa qui officia deserunt</p>
                </div>
                </div>
                <div class="postbox__comment mb-50">
                <h3 class="postbox__comment-title">2 Reviews for Poorex</h3>
                <ul>
                    <li>
                ...
                <div class="postbox__comment-form-box">
                    <h3 class="postbox__comment-form-title">Submit Your Review</h3>
                    ...
                    <form id="contact-form" action="#">
                        <div class="row">
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-6">
                                <div class="postbox__comment-input">
                                <input name="text" type="email" placeholder="Website">
                                </div>
                            </div>                         
                            <div class="col-xxl-12">
                            <div class="postbox__star">
                                ...
                                <div class="postbox__comment-btn d-flex align-items-center pt-35">
